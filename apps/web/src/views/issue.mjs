// views/issue.mjs — issue a new on-chain asset (constant / melting / growing), with a live
// rate-preview. Reads the live session/relay state from ctx; posts via the relay's issue endpoint.
...
async function issue() {
  try {
    ...
    // 'constant' = shift-64 INTEREST: growth of 2^-64/block floors to exactly zero at any age and
