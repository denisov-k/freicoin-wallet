...
const RU = {
  ...
  'Silvio Gesell': 'Сильвио Гезелль', 'Sign up': 'Зарегистрироваться', 'Log in': 'Войти', 'Back': 'Назад', 'New address': 'Новый адрес',
...
const ES = {
  ...
  'Sign up': 'Registrarse', 'Log in': 'Iniciar sesión', 'Back': 'Atrás', 'New address': 'Nueva dirección',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const DE = {
  ...
  'Sign up': 'Registrieren', 'Log in': 'Anmelden', 'Back': 'Zurück', 'New address': 'Neue Adresse',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const FR = {
  ...
  'Sign up': "S'inscrire", 'Log in': 'Se connecter', 'Back': 'Retour', 'New address': 'Nouvelle adresse',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const PT = {
  ...
  'Sign up': 'Cadastrar-se', 'Log in': 'Entrar', 'Back': 'Voltar', 'New address': 'Novo endereço',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const ZH = {
  ...
  'Silvio Gesell': '西尔维奥·格塞尔', 'Sign up': '注册', 'Log in': '登录', 'Back': '返回', 'New address': '新地址',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
