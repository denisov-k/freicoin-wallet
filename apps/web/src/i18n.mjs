...
const RU = {
  ...
  'Silvio Gesell': 'Сильвио Гезелль', 'Sign up': 'Зарегистрироваться', 'Log in': 'Войти', 'Back': 'Назад', 'New address': 'Новый адрес', 'Receiving': 'Получение',
...
const ES = {
  ...
  'Sign up': 'Registrarse', 'Log in': 'Iniciar sesión', 'Back': 'Atrás', 'New address': 'Nueva dirección', 'Receiving': 'Recepción',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const DE = {
  ...
  'Sign up': 'Registrieren', 'Log in': 'Anmelden', 'Back': 'Zurück', 'New address': 'Neue Adresse', 'Receiving': 'Empfang',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const FR = {
  ...
  'Sign up': "S'inscrire", 'Log in': 'Se connecter', 'Back': 'Retour', 'New address': 'Nouvelle adresse', 'Receiving': 'Réception',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const PT = {
  ...
  'Sign up': 'Cadastrar-se', 'Log in': 'Entrar', 'Back': 'Voltar', 'New address': 'Novo endereço', 'Receiving': 'Recebimento',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
...
const ZH = {
  ...
  'Silvio Gesell': '西尔维奥·格塞尔', 'Sign up': '注册', 'Log in': '登录', 'Back': '返回', 'New address': '新地址', 'Receiving': '收款',
  '⚠ Write these 12 words down. They are the ONLY key to your money — no one can recover them for you.':
