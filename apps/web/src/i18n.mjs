...
const RU = {
  ...
  'Name': 'Название', 'Rate k': 'Ставка k', 'Type': 'Тип', 'melts': 'плавится', 'grows': 'растёт', 'Quantity': 'Количество',
