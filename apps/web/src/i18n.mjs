...
const RU = {
  ...
  'no user-asset coins': 'нет монет активов', 'Buy': 'Купить', 'Bought': 'Куплено', 'You pay': 'К оплате', 'your coins are newer than this offer — the seller must refresh it': 'ваши монеты новее оффера — продавец должен его обновить',
