...
function renderWelcome() {
  $('#app').innerHTML = `<div class="lock"><div class="lockcard">
    ...
    <p class="sub"><a href="#" id="wDemo">${tr('try the shared demo wallet')}</a></p>
  ...
  $('#wDemo').onclick = e => {
    ...
    renderApp(); toast(tr('shared demo wallet (regtest) — do not store real funds here'));
  };
}
  ...
  try {
    ...
    $('#sendResult').innerHTML =
      `<div class="review">
         ...
         <div class="rrow"><span>${tr('Fee')}</span><b>${r.fee} kria</b></div>
         <div class="rrow"><span>${tr('Inputs')}</span><b>${r.inputs}</b></div>
