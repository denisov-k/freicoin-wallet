...
This is the one operational component variant B keeps; a fully zero-infra client
would need Freicoin nodes to expose a WebSocket P2P endpoint natively.
